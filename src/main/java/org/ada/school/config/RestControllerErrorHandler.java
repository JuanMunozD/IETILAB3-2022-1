...
class RestControllerErrorHandler
{
    ...
    {
        return new ResponseEntity<String>( exception.getCause().getMessage(), HttpStatus.BAD_REQUEST );
    }
    ...
    {
        return new ResponseEntity<ServerErrorResponseDto>( exception.getServerErrorResponseDto(), exception.getHttpStatus() );
    }
}
